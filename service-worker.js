const CACHE="bist-scanner-v4.1.3-mobile-stable-20260811";
const ASSETS=["./","./index.html","./style.css?v=4.1.3","./cloud-adapter.js?v=4.1.3","./app.js?v=4.1.3","./manifest.webmanifest"];
